...
class EbbotDemoAppInFullScreen extends StatelessWidget {
  final String botId;
  const EbbotDemoAppInFullScreen({super.key, required this.botId});
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: EbbotDemoAppInFullScreenHome(botId: botId),
    );
  }
}
...
class EbbotDemoAppInFullScreenHome extends StatelessWidget {
  final String botId;
  const EbbotDemoAppInFullScreenHome({super.key, required this.botId});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: OpenDialogButton(botId: botId),
      ),
    );
  }
}
...
class OpenDialogButton extends StatelessWidget {
  final String botId;
  const OpenDialogButton({super.key, required this.botId});
      ...
      onPressed: () {
        showDialog(
          ...
          builder: (BuildContext context) {
            return EbbotUiWidgetFullscreen(botId: botId);
          },
